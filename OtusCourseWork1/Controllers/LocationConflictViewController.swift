...
class LocationConflictViewController: UIViewController, UITableViewDataSource, UITableViewDelegate {
    ...
    weak var delegate: LocationConflictViewControllerDelegate?
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        dismiss(animated: true) {
            self.delegate?.locationConflictViewController(self, didSelectLocation: selectedLocation)
        }
    }
...
protocol LocationConflictViewControllerDelegate: AnyObject {
